...
use App\Http\Controllers\StreamingappController;
use App\Http\Controllers\JasajokiController;
use App\Http\Controllers\PulsautilitasController;
...
Route::get('/getservicevip', function(){
    Illuminate\Support\Facades\Artisan::call("ServiceVip");
});
...
//Menu Scroll
Route::get('/c/mobile-game',                         [MobilegameController::class, 'create'])->name('kategori');
Route::get('/c/pc-game',                         [PcgameController::class, 'create'])->name('kategori');
Route::get('/c/streaming-app',                         [StreamingappController::class, 'create'])->name('kategori');
Route::get('/c/jasa-joki',                         [JasajokiController::class, 'create'])->name('kategori');
Route::get('/c/pulsa-utilitas',                         [PulsautilitasController::class, 'create'])->name('kategori');
Route::get('/c/kode-voucher',                         [EwalletController::class, 'create'])->name('kategori');
...
Route::middleware(['auth', 'check.role'])->group(function (){
    ...
    Route::get('/berita/inactive/{id}',                     [Berita::class, 'inactive'])->name('berita.inactive');
    Route::get('/berita/activate/{id}',                     [Berita::class, 'activate'])->name('berita.activate');
    ...
    Route::post('/layanan/update',                           [LayananController::class, 'patch'])->name('layanan.detail.update');
    ...
    Route::post('/setting/hargamembership', [SettingWebController::class,'saveSettingHargamembership']);
