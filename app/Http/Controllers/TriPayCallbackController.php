...
class TriPayCallbackController extends Controller
{
        ...
        if ($data->is_closed_payment === 1) {
            ...
            switch ($status) {
                case 'PAID':
                    ...
                    $pesanAdmin = $this->msg($this->api->nomor_admin, $pesanAdmin);
                ...
                $updatesisa = Layanan::where('id', $dataLayanan->id)->update(['sisa' => $sisa]);
                 }
    ...
    public function msg($nomor, $msg)
    {
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => "https://api-wa.miliyan.id/send-message",
