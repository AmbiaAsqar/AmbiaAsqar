...
class LayananController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $layanan->harga_awal = $request->awal;
        ...
        $layanan->event = $request->serverOption == 'ya' ? 1 : 0;
        $layanan->sisa = $request->sisa;
        $layanan->catatan = '';
    ...
    public function detail($id)
    {
        ...
        $send = "
                <form action='".route("layanan.detail.update", [$id])."' method='POST' enctype='multipart/form-data'>
                    ...
                    <div class='mb-3 row'>
                        ...
                        <div class='col-lg-10'>
                            <select class='form-select' name='provider'>
                                ...
                                <option value='mix_digiflazz'>Mix (Digiflazz)</option>
                    ...
                    <div class='mb-3 row'>
                        <label class='col-lg-2 col-form-label' for='example-fileinput'>Harga awal flash sale</label>
                        <div class='col-lg-10'>
                            <input type='number' class='form-control' value='". $data->harga_awal ."' name='harga_awal'>
                        </div>
                    </div>
                    <div class='mb-3 row'>
                    ...
                    <div class='mb-3 row'>
                        ...
                        <div class='col-lg-10'>
                            <input type='file' class='form-control' value='" . $data->product_logo . "' name='product_logo'>
                        </div>
                    </div>
                    <div class='mb-3 row'>
                        <label class='col-lg-2 col-form-label' for='example-fileinput'>Promo Flash Sale?</label>
                        <div class='col-lg-10'>
                            <select class='form-control' name='flash'>
                                <option value='".$data->flash."'>".$data->flash."</option>
                     ...
                     <div class='mb-3 row'>
                        <label class='col-lg-2 col-form-label' for='example-fileinput'>Stok Flash Sale</label>
                        <div class='col-lg-10'>
                            <input type='number' class='form-control' value='" . $data->sisa . "' name='sisa'>
                        </div>
                    </div>
                    <div class='mb-3 row'>
    ...
    public function patch(Request $request, $id)
    {
        ...
        if($request->file('product_logo')){
            ...
            $folder = 'assets/product_logo';
            $file->move($folder, $file->getClientOriginalName());      
            Layanan::where('id', $id)->update([
                'product_logo' => "/".$folder."/".$file->getClientOriginalName()
            ]);
        }
