...
<div class="mb-3 row">
                <label class="col-lg-2 col-form-label">Flash Sale Produk</label>
                <div class="col-lg-10">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-lg-10">
                    <input type="number" class="form-control @error('sisa') is-invalid @enderror" value="{{ old('sisa') }}" name="sisa">
                    @error('sisa')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
             ...
             <div class="mb-3 row">
                <label class="col-lg-2 col-form-label" for="example-fileinput">Harag Awal Flash Sale</label>
                <div class="col-lg-10">
                    <input type="number" class="form-control @error('awal') is-invalid @enderror" value="{{ old('awal') }}" name="awal">
                    @error('awal')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-lg-5">
                    ...
                    @enderror
                    <small class="text-danger">*Jika ingin mix pastikan provider nya pilih Mix (Digiflazz). Masukkan provider ID Digiflazz dan pisahkan dengan koma. Contoh: mlbb5,mlbb3</small>
                </div>
            </div>
