    ...
    <div class="card-body">
        ...
        <form action="{{ route('kategori.post') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control @error('format_pemisah') is-invalid @enderror" value="{{ old('format_pemisah') }}" name="format_pemisah">
                    @error('format_pemisah')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                    @enderror
                    ...
                    <table class="table m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-truncate" style="max-width: 100px;">{{ $datas->deskripsi_game }}</td>
                                <td class="text-truncate" style="max-width: 100px;">{{ $datas->deskripsi_field }}</td>
                                <td>
