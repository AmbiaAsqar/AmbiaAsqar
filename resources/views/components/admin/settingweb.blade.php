...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">Konfigurasi Website</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item active">Admin/Website</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="card-body">
        ...
        <form action="{{ url('/setting/web') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="mb-3 row">
                    <label class="col-lg-2 col-form-label" for="example-fileinput">Alfareza API</label>
                    <div class="col-lg-10">
                        <input type="text" class="form-control" value="{{$web->miliyan_api}}" name="miliyan_api" >
                    </div>
                </div>
                <div class="mb-3 row">
             ...
             <div class="mb-3 row">
                    <label class="col-lg-2 col-form-label" for="example-fileinput">Jam akhir flash sale</label>
                    <div class="col-lg-10">
                        <input type="time" class="form-control" value="{{$web->waktu}}" name="waktu" >
                    </div>
                </div>
            <div class="mb-3 row">
                    <label class="col-lg-2 col-form-label" for="example-fileinput">Tanggal akhir flash sale</label>
                    <div class="col-lg-10">
                        <input type="date" class="form-control" value="{{$web->tanggal}}" name="tanggal" >
                    </div>
                </div>
            </div>
