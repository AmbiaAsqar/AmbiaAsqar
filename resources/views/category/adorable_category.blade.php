...
<main id="main">
    ...
    <div id="mobileMainDetection" class="container-fluid container-md p-0">
        <div class="d-none d-md-flex justify-content-center mt-5 mx-5 px-5" style="display: none !important">
            <!-- SKELETON START -->
            ...
            <div class="row justify-content-around w-100 m-0 p-0">
                <div class="col-12 col-md-8 p-0">
                    ...
                    <div class="d-flex">
                        ...
                        <!-- END
                        ---- START CONTENT BIG -->
                        <div class="d-none d-lg-block main-topic" id="main-topic" style="display: none">
