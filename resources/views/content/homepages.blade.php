                    ...
                    <div class="card mr-2 bg-transparent border-0 d-none d-lg-block" style="width: 450px">
                        ...
                        <div class="card-body px-0 pt-1">
                            ...
                            <span class="c" style="display: none">
                                <span class="little-tag text-light" style="background-color: {{ Http::withHeaders(["Authorization" => bcrypt(env("APP_KEY").env("API_KEY"))])->get(env('API_URL').'/getcategorydetail/1')[0]['color'] }};">{{ Http::withHeaders(["Authorization" => bcrypt(env("APP_KEY").env("API_KEY"))])->get(env('API_URL').'/getcategorydetail/1')->json()[0]['title'] }}</span>
                    ...
                    <div class="d-none d-lg-block">
                        ...
                        <div class="con con-news mb-2 m-0">
                            ...
                            <div class="con-body">
                                <div class="c skeleton" style="width: 70px; height: 20px"></div>
                                <span class="c" style="display: none">
                                    <span class="little-tag text-light" style="background-color: {{ Http::withHeaders(["Authorization" => bcrypt(env("APP_KEY").env("API_KEY"))])->get(env('API_URL').'/getcategorydetail/1')->json()[0]['color'] }};">{{ Http::withHeaders(["Authorization" => bcrypt(env("APP_KEY").env("API_KEY"))])->get(env('API_URL').'/getcategorydetail/1')->json()[0]['title'] }}</span>
                    ...
                    <div class="col-lg-6 col-12 p-0">
                        <div class="con con-news">
                            ...
                            <div class="con-body">
                                <div class="c skeleton" style="width: 70px; height: 20px"></div>
                                <span class="c" style="display: none">
                                    <span class="little-tag text-light" style="background-color: {{ Http::withHeaders(["Authorization" => bcrypt(env("APP_KEY").env("API_KEY"))])->get(env('API_URL').'/getcategorydetail/'.$ghn['category_id'])->json()[0]['color'] }};">{{ Http::withHeaders(["Authorization" => bcrypt(env("APP_KEY").env("API_KEY"))])->get(env('API_URL').'/getcategorydetail/'.$ghn['category_id'])->json()[0]['title'] }}</span>
                                </span>
                                <div class="h3 skeleton" style="width: 200px; height: 25px; margin-bottom: 10px"></div>
                                <div class="hide" style="display: none">
                        ...
                        <div class="con con-news" style="width: 100%; max-width: 100%; max-height: 500px">
                            <div class="d-md-flex d-block w-100" style="overflow: hidden">
                                ...
                                <div class="con-body" style="position: relative">
                                    ...
                                    <span class="c" style="display: none">
                                        <span class="little-tag text-light" style="background-color: {{ Http::withHeaders(["Authorization" => bcrypt(env("APP_KEY").env("API_KEY"))])->get(env('API_URL').'/getcategorydetail/'.$d['category_id'])->json()[0]['color'] }};">{{ Http::withHeaders(["Authorization" => bcrypt(env("APP_KEY").env("API_KEY"))])->get(env('API_URL').'/getcategorydetail/'.$d['category_id'])->json()[0]['title'] }}</span>
