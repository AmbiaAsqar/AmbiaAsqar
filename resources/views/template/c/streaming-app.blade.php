...
<div class="header px-3 border-bottom d-md-none">
	...
	<span class="color d-inline-block ms-5 title">Streaming App</span>
</div>
...
<div class="content-body">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <section class="px-2 item-skeleton-content d-none mt-5" style="">
                <h4 class="mb-3" style="font-size: 1.2rem;"><i class="bi bi-grid-fill" style="color: var(--warna_2);"></i> Streaming App</h4>
                <div class="product row pt-4">
                    
                    @foreach($kategori as $category)
                    
                    @if($category->kategori == "streaming-app")
