    ...
    <body>
        <div class="content" bis_skin_checked="1">
    		...
    		<div class="area" bis_skin_checked="1">
    			<h3>Daftar</h3>
				<p class="mb-2">Masukkan informasi pendaftaran yang valid.️</p>
				@if ($errors->any())
    			...
    			<div class="form-area">
				    ...
				    @csrf
    					...
    					<button class="btn btn-primary w-100" type="submit" name="tombol" value="submit">Daftar</button>
    				</form>
    				
    				<div class="text-center my-4" bis_skin_checked="1">
    					<p>Sudah punya akun?</p>
    				</div>
    				<a href="/login" class="btn btn-secondary button-daftar w-100 mb-3" bis_skin_checked="1">Login Sekarang</a>
    			</div>
    		</div>
    	</div>
    </body>    
