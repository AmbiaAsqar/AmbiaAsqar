                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                    <a href="{{ route('berita') }}" class="dropdown-item">Slide</a>
                                    <a href="{{ route('method') }}" class="dropdown-item">Metode Pembayaran</a>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            </script> &copy; {{ ENV('APP_NAME') }} by <a href="https://kontergame.id">Kontergame.id</a>
                        </div>
                        <div class="col-md-6">
